            ...
            5: [
                function (require, module, exports) {
                    ...
                    module.exports = function (chai, _) {
                        ...
                        Assertion.addMethod("within", function (
                            start,
                            finish,
                            msg
                        ) {
                        ...
                        function assertKeys(keys) {
                            ...
                            if (objType === "Map" || objType === "Set") {
                                ...
                                if (keysType !== "Array") {
                                    keys = Array.prototype.slice.call(
                                        arguments
                                    );
                                }
                            } else {
                        ...
                        Object.defineProperty(ctx, name, {
                            get: function chainableMethodGetter() {
                                ...
                                // Otherwise, redefine all properties (slow!)
                                    ...
                                    var asserterNames = Object.getOwnPropertyNames(
                                        ctx
                                    );
                                    asserterNames.forEach(function (
                                        asserterName
                                    ) {
                                        if (
                        ...
                        return new Proxy(obj, {
                            get: function proxyGetter(target, property) {
                                ...
                                if (
                                    ...
                                    getProperties(target).forEach(function (
                                        prop
                                    ) {
                                        if (
                ...
                function (require, module, exports) {
                    ...
                    function getFunctionName(constructorFn) {
                        ...
                        if (typeof constructorFn.name === "undefined") {
                            ...
                            var match = String(constructorFn).match(
                                functionNameMatch
                            );
                            if (match) {
                                name = match[1];
...
*/
                    ...
                    function entriesEqual(
                        ...
                        var leftHandItems = [];
                        var rightHandItems = [];
                        leftHandOperand.forEach(function gatherEntries(
                            key,
                            value
                        ) {
                            leftHandItems.push([key, value]);
                        });
                        rightHandOperand.forEach(function gatherEntries(
                            key,
                            value
                        ) {
                    ...
                    function objectEqual(
                        ...
                        if (
                            ...
                            rightHandKeys.sort();
                            if (
                                iterableEqual(leftHandKeys, rightHandKeys) ===
                                false
                            ) {
                                return false;
                            }
                        ...
                        var leftHandEntries = getIteratorEntries(
                            leftHandOperand
                        );
                        var rightHandEntries = getIteratorEntries(
                            rightHandOperand
                        );
                        if (
